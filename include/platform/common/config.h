...
#define GAMEYOB_PAUSE_IN_MENU 0

#ifndef BACKEND_SWITCH
#define GAMEYOB_CONSOLE_OUTPUT 1
...
#define GAMEYOB_SAVE_PATH 1
#define GAMEYOB_SAVE_STATE_PATH 2
#define GAMEYOB_CHEATS_PATH 3
#define GAMEYOB_BORDER_PATH 4
#define GAMEYOB_PRINT_PATH 5
...
#define DISPLAY_SCALING_MODE 0
#define DISPLAY_SCALING_FILTER 1
#define DISPLAY_FF_FRAME_SKIP 2
#define DISPLAY_COLORIZE_GB 3
#define DISPLAY_RENDERING_MODE 4
#define DISPLAY_EMULATE_BLUR 5
#define DISPLAY_CUSTOM_BORDERS 6
#define DISPLAY_CUSTOM_BORDERS_SCALING 7

#define DISPLAY_CUSTOM_BORDER_PATH 0

#define SCALING_MODE_OFF 0
#define SCALING_MODE_ASPECT 1
#define SCALING_MODE_ASPECT_SCREEN_ONLY 2
#define SCALING_MODE_FULL 3
#define SCALING_MODE_FULL_SCREEN_ONLY 4
